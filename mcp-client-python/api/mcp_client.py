        ...
        try:
            ...
            if server_script_path.startswith("http://") or server_script_path.startswith("https://"):
                ...
                if not (is_python or is_js):
                    raise ValueError("Server script must be a .py, .js file, or a valid URL")
